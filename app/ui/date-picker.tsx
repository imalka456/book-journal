...
type DatePickerProps = {
  ...
  const DatePicker: React.FC<DatePickerProps> = ({ selectedDate, onDateChange, label }) => {
    ...
    return (
      <div id="date-picker" className="relative border border-gray-300 rounded focus-within:border-dark-blue">
        <div className="flex">
            ...
            <div>
                ...
                <div className={`text-2xl mr-2 ${selectedDate ? "text-gray-700" : "text-gray-400"}`} ><MdOutlineDateRange className={`text-2xl mr-2 ${selectedDate ? "text-gray-700" : "text-gray-400"}`}/></div>
